...
//    ),
    [_BASE] = LAYOUT_65_ansi_blocker(
        ...
        KC_LSFT,   KC_Z,     KC_X,    KC_C,    KC_V,     KC_B,     KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH,   KC_RSFT,                         KC_UP,     OS_TMP_DEFT,
        KC_LCTL,   KC_LGUI,  KC_LALT,                              KC_SPC,                                         MO(_FN),  MO(_UTIL), KC_LEFT,    KC_DOWN,   KC_RIGHT
    ),
    [_FN] = LAYOUT_65_ansi_blocker(
        KC_GRV,    KC_F1,    KC_F2,   KC_F3,   KC_F4,    KC_F5,    KC_F6,   KC_F7,    KC_F8,   KC_F9,   KC_F10,    KC_F11,    KC_F12,    _______,              OS_DEF,
        ...
        _______,   _______,  _______, _______, _______,  _______,  _______, _______,  _______, _______, _______,   _______,                         _______,   KC_INSERT,
        _______,   _______,  _______,                              _______,                                        _______,   _______,   _______,   _______,   _______
    ),
...
const led_map_t PROGMEM led_map[][RGBLED_NUM] = {
    ...
    [_FN] = LED_MAP_LAYOUT(
        ...
        _______,   _______,  _______, _______, _______,  _______,  _______, _______, _______,  _______, _______,   _______,                         _______,   LED_COM,
        _______,   _______,  _______,                              _______,                                        _______,   _______,  _______,    _______,   _______
    ),
    ...
    [_RGB] = LED_MAP_LAYOUT(
        LED_COM,   LED_TCC,  LED_TCC, LED_TCC, LED_TCC,  _______,  _______, _______, _______,  _______, _______,   LED_TCC,   LED_TCC,  _______,               LED_TCC,
        ...
        _______,   _______,  _______, _______, _______,  _______,  _______, _______, LED_TCC,  LED_TCC, _______,   _______,                         LED_TCC,   _______,

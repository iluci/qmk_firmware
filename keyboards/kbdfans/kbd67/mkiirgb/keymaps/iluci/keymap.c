...
//      Ct_L       Win_L     Alt_L                               SPACE                                          FN         Ct_R      Left       Down       Right
    [_BASE] = LAYOUT_65_ansi_blocker(
        ...
        KC_LCTL,   KC_LGUI,  KC_LALT,                            KC_SPC,                                        MO(_FN1),  KC_RCTRL, KC_LEFT,   KC_DOWN,   KC_RIGHT
    ),
    [_FN1] = LAYOUT_65_ansi_blocker(
        KC_GESC,   KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,    KC_F11,    KC_F12,    KC_DEL,               OS_DEFT,
        ...
        _______,   _______,  _______,                            _______,                                       _______,   TT(_UTIL), _______,   _______,   _______
    ),
    [_UTIL] = LAYOUT_65_ansi_blocker(
        TG(_UTIL), _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______,   _______,  _______,              RGB_TG,
...
const led_map_t PROGMEM led_map[][DRIVER_LED_TOTAL] = {
    ...
    [_FN1] = LED_MAP_LAYOUT(
        ...
        _______,   _______,  _______, _______, _______, _______, _______, _______, _______, _______, LED_TCC,   _______,   _______,  _______,              LED_WIN,

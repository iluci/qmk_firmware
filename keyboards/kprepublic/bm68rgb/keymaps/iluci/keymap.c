...
//      Ct_L      Win_L       Alt_L                            SPACE                                                  Alt_R      FN         Ct_R       Left       Down       Right
    [_BASE] = LAYOUT_65_ansi(
        ...
        TD_CAPS,  KC_A,       KC_S,      KC_D,      KC_F,      KC_G,      KC_H,      KC_J,      KC_K,      KC_L,      KC_SCLN,   KC_QUOT,   KC_ENT,                          KC_END,
    ...
    [_FN1] = LAYOUT_65_ansi(
        KC_GRAVE,  KC_F1,     KC_F2,     KC_F3,     KC_F4,     KC_F5,     KC_F6,     KC_F7,     KC_F8,     KC_F9,     KC_F10,    KC_F11,    KC_F12,    _______,              OS_DEFT,
...
const led_map_t PROGMEM led_map[][DRIVER_LED_TOTAL] = {
    ...
    [_FN1] = {
        _______,   LED_TC,    _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,              LED_DFT,
        _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   LED_TCC,   _______,   _______,   _______,              LED_WIN,
        _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,                         LED_MAC,
        _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,                         _______,   _______,
        _______,   _______,   _______,                         _______,                                               LED_TCC,   _______,   _______,   _______,   _______,   _______
    },
    [_UTIL] = {
        _______,   _______,   LED_TC,    _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,              LED_TCC,
        _______,   LED_TCC,   LED_TCC,   LED_TCC,   _______,   _______,   LED_TCC,   LED_TCC,   LED_TCC,   LED_TCC,   LED_TCC,   _______,   _______,   LED_COM,              LED_TCC,
        _______,   LED_TCC,   LED_TCC,   LED_TCC,   _______,   _______,   LED_TCC,   LED_TCC,   LED_TCC,   LED_TCC,   LED_TCC,   LED_TCC,   _______,                         LED_TCC,
        _______,   _______,   _______,   _______,   _______,   _______,   LED_TCC,   LED_TCC,   LED_TCC,   LED_TCC,   LED_TCC,   _______,                         _______,   LED_TCC,
        _______,   _______,   _______,                         _______,                                               _______,   _______,   _______,   _______,   _______,   _______
    },
};

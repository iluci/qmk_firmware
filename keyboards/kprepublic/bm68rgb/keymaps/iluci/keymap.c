...
const led_map_t PROGMEM led_map[][DRIVER_LED_TOTAL] = {
    ...
    [_UTIL] = {
        ...
        _______,   LED_TCC,   LED_COM,   LED_TCC,   LED_TCC,   _______,   LED_TCC,   LED_COM,   LED_COM,   LED_COM,   LED_TCC,   _______,   _______,   LED_TC,               LED_TCC,
        LED_CAPS,  LED_COM,   LED_COM,   LED_COM,   LED_TCC,   _______,   LED_TCC,   LED_COM,   LED_COM,   LED_COM,   LED_TCC,   LED_TCC,   _______,                         LED_TCC,
        _______,   _______,   _______,   _______,   _______,   _______,   LED_TCC,   LED_COM,   LED_COM,   LED_COM,   LED_TCC,   _______,                         _______,   LED_TCC,
        _______,   _______,   _______,                         _______,                                               _______,   _______,   _______,   _______,   _______,   _______
    },
};

...
//      Ct_L      Win_L    Alt_L                        SPACE                                           Alt_R    FN        Ct_R      Left     Down     Right
    ...
    [_BASE] = LAYOUT_65_ansi(
        ...
        KC_LCTL,  KC_LGUI, KC_LALT,                     KC_SPC,                                         KC_RALT, TT(_FN1), KC_RCTRL, KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_FN1] = LAYOUT_65_ansi(
        KC_GRAVE, KC_F1,   KC_F2,   KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,  _______,          OS_DEFT,
        _______,  KC_BTN1, KC_MS_U, KC_BTN1,  _______,  _______,  _______,  _______,  _______, _______, KC_PSCR,  _______,  _______, RESET,            OS_WIN,
        _______,  KC_MS_L, KC_MS_D, KC_MS_R,  _______,  _______,  _______,  _______,  _______, _______, _______,  _______,  _______,                   OS_MAC,
        _______,  RGB_TG,  RGB_EF,  RGB_CO,   RGB_VAI,  _______,  _______,  _______,  _______, _______, _______,  _______,                    _______, _______,
        _______,  _______, _______,                     _______,                                        _______,  _______,  _______, _______, _______, _______
    ),


    // [_FN1] = LAYOUT_65_ansi(
    //     KC_GRAVE, KC_F1,   KC_F2,   KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,  _______,          RGB_TG,
